 ...
 *
 * @type {(OPUS|PCMU|RAW|PCMA|TELEPHONE_EVENT)}
 */
...
function checkAudioCodec(key, value) {
  ...
  if (!value.match('OPUS|PCMU|RAW|PCMA|TELEPHONE_EVENT'))
    throw SyntaxError(key + ' param is not one of [OPUS|PCMU|RAW|PCMA|TELEPHONE_EVENT] (' + value + ')');
};
